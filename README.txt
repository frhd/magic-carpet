...
This is the readme for Magic Carpet, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. MagicCarpet) > Ok.
...
- To run the project find MagicCarpet.java (which will be in under src/main/java/me/frhd) and right click > Run 'MagicCarpet'
